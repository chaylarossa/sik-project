                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="GET" action="{{ route('archive.index') }}" class="mb-6 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        ...
                        <div class="flex items-end gap-2">
                            ...
                            @can('export data')
                            <button type="submit" formaction="{{ route('archive.export.pdf') }}" class="inline-flex items-center px-4 py-2 bg-red-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-500 active:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                {{ __('PDF') }}
                            </button>
                            @endcan
                        </div>
