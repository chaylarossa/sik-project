...
<div class="space-y-6">
    <div>
        ...
        <x-text-input
            ...
            type="text"
            class="mt-2 w-full"
            :value="old('name', $crisisType->name ?? '')"
            maxlength="100"
            required
        />
    ...
    <div>
        ...
        <x-text-input
            ...
            type="text"
            class="mt-2 w-full"
            :value="old('code', $crisisType->code ?? '')"
            maxlength="50"
            required
        />
        <p class="mt-1 text-sm text-gray-500">Gunakan huruf/angka tanpa spasi (mis. FIRE, FLD-01).</p>
    ...
    <div class="flex items-center gap-3">
        ...
        <input
            ...
            @checked(old('is_active', $crisisType->is_active ?? true))
        >
