            ...
            <table class="min-w-full divide-y divide-gray-100 text-sm">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left font-semibold text-gray-600">Wilayah</th>
                ...
                <tbody class="divide-y divide-gray-100 bg-white">
                            ...
                            <td class="px-4 py-3 text-gray-700">
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    @if ($report->verification_status === CrisisReport::VERIFICATION_PENDING)
                                        <a href="{{ route('reports.verify', $report) }}" class="inline-flex items-center rounded-md bg-indigo-600 px-3 py-1 text-xs font-semibold text-white shadow-sm hover:bg-indigo-500">Verifikasi</a>
                                    @else
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-4 py-6 text-center text-gray-500">Tidak ada laporan untuk status ini.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
